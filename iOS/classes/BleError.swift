...
extension BluetoothError {
    var bleError: BleError {
        ...
        case let .characteristicsDiscoveryFailed(characteristic, error):
            return error.bleError(errorCode: .CharacteristicsDiscoveryFailed,
                                  deviceID: characteristic.peripheral.identifier.uuidString,
        ...
        default:
            return BleError(errorCode: .UnknownError, reason: "Unknown Bluetooth error")
        }
    }
}
