Pod::Spec.new do |spec|
  spec.name         = "MultiplatformBleAdapterKN"
  spec.version      = "0.1.9"
  ...
  spec.homepage     = "https://github.com/KamilNatonek/MultiPlatformBleAdapterKN"
  ...
  spec.source       = { :git => "https://github.com/KamilNatonek/MultiPlatformBleAdapterKN.git", :tag => "#{spec.version}" }
